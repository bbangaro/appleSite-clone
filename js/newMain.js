(() => {
    ...
    function playAnimation() {
        ...
        //  yOffset - prevScollHeight  / 현재 씬의 scrollHeight
        const scrollHeight = sceneInfo[currentScene].scrollHeight;
        const scrollRatio = currentYOffset / scrollHeight;
        ...
        switch (currentScene) {
            ...
            case 2:
                ...
                if (scrollRatio <= 0.5) {
                    // in
                    objs.canvas.style.opacity = calcValues(value.canvas_opacity_in, currentYOffset);
                } else {
                    // out
                    objs.canvas.style.opacity = calcValues(value.canvas_opacity_out, currentYOffset);
                }
